...
/**
 * @brief Acende o LED amarelo com a intensidade especificada.
 * 
 * @param pins Estrutura contendo os pinos dos LEDs RGB.
 * @param intensity Intensidade do LED amarelo, variando de 0 a 100.
 */
void rgb_turn_on_yellow(const rgb_t *pins, uint8_t intensity);

/**
 * @brief Desliga o LED amarelo.
 * 
 * @param pins Estrutura contendo os pinos dos LEDs RGB.
 */
void rgb_turn_off_yellow(const rgb_t *pins);
